...
# симуляція роботи
print("Your name: Valentin")
Valentin = Customer()
print("You want: a pineapple")
print("Your credit information: Valentin-232232")
Valentin.orderItem("Pineapple", "Valentin-232232")
