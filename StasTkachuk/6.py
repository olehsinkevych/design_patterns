...
class Payment:
    def __init__(self):
        self.details = []
        self.details.append("Semen-333444")
...
# симуляція роботи
print("Your name: Stanislav")
Valentin = Customer()
print("You want: a cherry")
print("Your credit information: Stanislav-123456")
Valentin.orderItem("Cherry", "Stanislav-123456")