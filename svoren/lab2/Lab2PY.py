...
class Staff(Person):
    def __init__(self,name="Ivan",address="Universitetska 1",school="Ivan Franko National University of Lviv",pay=15675.5):
        super().__init__(name,address)
...
yaroslav1 = Person()
yaroslav1.to_string()
yaroslav2 = Student("Yaroslav","Liberty Avenue 19")
yaroslav2.to_string()
yaroslav3 = Staff("Oleh","Dragomanova 50")
yaroslav3.to_string()